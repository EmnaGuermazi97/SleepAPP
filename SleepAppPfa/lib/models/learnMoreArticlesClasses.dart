...
List<ArticleLearnMore> articles = [
  ...
  ArticleLearnMore(
      ...
      miniTitles: [
        '1.Turn off the TV',
        '2.Grab a Cup of Tea',
        '3Take an Omega-3 Supplement',
        '4.Break a Sweat',
        '5.Be Mindful of Your Meds',
        '6.Skip the Smokes',
        '7. Make Some Time For Self-Care'
      ],
      paragraphes: [
        'Reasearches have found that watching TV before bed may make a person chronically sleep-deprived, as it often prompts people to go against their biological sleep cues. For a more restful evening, turn off the TV a few hours before bed and enjoy some less-disruptive activities, like reading, instead. ',
        ...
        'Fish oil is great for your heart, but did you know that it is also pretty effective when it comes to your sleep habits, too?',
        'Before you pop a sleeping pill, try taking a few laps around the block first. Exercise is a great way to develop healthier sleep habits and get yourself physically tired enough to crawl into bed.',
        'If you are having trouble sleeping, it might be worth shifting your medication schedule. Everything from antidepressants to ADHD medications to OTC headache cures can interfere with your sleep, so if you are struggling to sleep, ask your doctor if taking your meds in the morning is an option.',
        'Ending the evening with a cigarette or vape might be the reason you are having such a hard time getting enough rest.To sleep better, skip the smokes before bed—or, better yet, try to quit them for good as soon as possible.',
        'Taking some time for yourself at the end of the day can make a major difference in how you sleep. Few studies  suggests that stress can significantly reduce sleep quality and quantity, so add some technology-free activities that help you relax, like reading or taking a bath, to your evening and you might just wake up well-rested for once.'
      ],
  ...
  ArticleLearnMore(
      ...
      miniTitles: [
        'Intro: ',
        'Not having an organized sleeping schedule :',
        'Sleeping in— on weekends: ',
        'Napping: ',
        'Giving to drowsiness before your bed time: ',
        'Bright screens around your bedtime : '
      ],
      paragraphes: [
